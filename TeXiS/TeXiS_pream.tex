...
\usepackage{verbatim}
% El paquete pmboxdraw  es utilizado para dibujar los arboles
...
% para las definitions
\usepackage{amsthm}
% Para la tabla con celda partida 
\usepackage{diagbox}
% para el tick de la tabla
\usepackage{amssymb}
% para la x de la tabla
\usepackage{pifont}
% para tabla rotada
\usepackage{rotating}

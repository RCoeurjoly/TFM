...
\begin{itemize}
    ...
    \item Transforming the execution tree.\todo{Aquí tiene sentido que sea el debugging tree, porque la ejecución es única y no tiene sentido modificarla.}

...
\begin{itemize}
    ...
    The node can be removed from the debugging tree or the navigation strategy can choose another node, leaving this node in the tree.\todo{Contar que puede introducir incompletitud y que hay

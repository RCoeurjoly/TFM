...
%Completion theorem
Let \(T = (N,E,W,M)\) be a weighted marked execution tree and \(S\) the top-down strategy\todo{Se ha definido esta estrategia antes?} and the root node of \(T\) a wrong node.
...
Let:
\begin{itemize}
    \item \(T = (N,E,W,M)\) be a weighted marked execution tree,

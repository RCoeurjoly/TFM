...
%
The identification of issues and solutions comes from the 2017 survey \cite{Survey}. Latter research is included when appropriate. Also, we also mention where DDC contributes to the state of the art: a new tree transformation called simplified tree compression and the support for non terminating programs. \todo{Estaría bien si a lo largo de la sección cuentas si tu depurador aporta algo nuevo a este estado del arte.}
